...
public class MainSieczne {
    ...
    public static void main(String[] args){
        ...
        System.out.println(sieczna(a,b,epsilon,3));
        //System.out.println(x(a,b,0,false));

        //System.out.println(sieczna(a,b,epsilon));
    }

    private static double sieczna(double a,double b,double epsilon, int i){
        double wynik = 0;
    ...
    // funkcje do wyliczania x
        ...
        // true -> x0 = b, nieruchome a
        // false -> x0 = a, nieruchome b
    ...
    private static double x(double a,double b,int i){
        if(i==0){
            if(x0(a,b) == b) {
                return x0(a, b) - (funkcja(x0(a, b)) / (funkcja(x0(a, b)) - funkcja(a))) * (x0(a, b) - a);
            }else if(x0(a,b) == a){
                return x0(a, b) - (funkcja(x0(a, b)) / (funkcja(x0(a, b)) - funkcja(a))) * (b - x0(a, b));
            }else {
                return 0;
            }
        }else {
            if(x0(a,b) == b){
                return x(a,b,i-1) - (funkcja(x(a,b,i-1)) / (funkcja(x(a,b,i-1)) - funkcja(a))) * (x(a,b,i-1) - a) ;
            }else if(x0(a,b) == a){
                return x(a, b, i - 1) - (funkcja(x(a, b, i - 1)) / (funkcja(x(a, b, i - 1)) - funkcja(a))) * (b - x(a, b, i - 1));
            }else {
                return 0;
            }
        }
